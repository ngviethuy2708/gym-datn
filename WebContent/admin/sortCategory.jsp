		...
		<div class="row">
			...
			<div class="col-md-10 main">
				<div class="search-form">
					<div class="col-md-2">
					<p>
						<a href="<%=request.getContextPath()%>/admin/indexRegister" class="btn btn-success create-button"  margin-top: 41px;">Quay lại</a>
		        	</p>
		    	</div>	
				</div>
				<!-- end search form -->
        		    		...
        		    		<div class="portfolio">
        		    			<div class="single_protfolio">
        		    				<div class="prot_imag">
        		    					...
        		    					<a class="venobox vbox-item" href="/Nhung-lan-quay-pha-83.html" title="<%=objCategory.getName()%>" target="_blank">
