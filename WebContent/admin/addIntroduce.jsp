...
<%@include file="/templates/admin/inc/header.jsp" %>
	...
	<div class="container">
		<div class="row body-form">
			<div class="col-md-12">
				<form class="form-horizontal form_addIntroduce" enctype="multipart/form-data" role="form" method="post" action="<%=request.getContextPath() %>/admin/addIntroduce">
					<div class="form-group">
    					<label for="inputEmail3" class="col-sm-2 control-label">lời giới thiệu</label>
   						<div class="col-sm-10">
      						<input type="text" name="nameIntroduce" style="width:587px;" class="form-control required" id="username" placeholder="">
    					</div>
 					</div>
 					<div class="form-group">
