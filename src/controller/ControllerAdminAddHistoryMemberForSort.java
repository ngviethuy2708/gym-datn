...
public class ControllerAdminAddHistoryMemberForSort extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ControllerAdminAddHistoryMemberForSort() {
        super();
		...
		if(resultHistory > 0){
			...
			if(resultUpdateMember > 0){
				...
				if(resultUpdateExpired > 0){
					response.sendRedirect(request.getContextPath()+"/admin/indexRegister?active=success");
				}
			}
		}
		/*if(result > 0){
