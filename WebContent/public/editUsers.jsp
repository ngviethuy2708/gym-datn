...
<%@include file="/templates/public/inc/header.jsp" %>
	...
	<div class="main-content">
			...
			<div class="col-md-12">
			<form class="form-horizontal form_editUsers" role="form" method="post" action="<%=request.getContextPath() %>/editUsers?uid=<%=objUsers.getIdUser()%>">
				<div class="form-group">
    					<label for="inputEmail3" class="col-sm-2 control-label">Username</label>
   						<div class="col-sm-10">
      						<input type="text" name="userName" class="form-control required" id="username" placeholder="" value="<%=objUsers.getUserName()%>">
      						<% if(!output.equals("")){%>
      						<p style="color:red;" >
 					...
 					<div class="form-group">
    					<label for="inputEmail3" class="col-sm-2 control-label">Password</label>
   						<div class="col-sm-10">
      						<input type="passWord" name="passWord" class="form-control" id="password" placeholder="" value="<%=objUsers.getPassWord()%>">
    					</div>
 					</div>
 					<div class="form-group">
    					<label for="inputEmail3" class="col-sm-2 control-label">Họ tên</label>
   						<div class="col-sm-10">
      						<input type="text" name="fullName" class="form-control" id="fullname" placeholder="" value="<%=objUsers.getFullName()%>"">
    					</div>
 					 </div>
 					<div class="form-group">
    					<label for="inputEmail3" class="col-sm-2 control-label">Ngày sinh</label>
   						<div class="col-sm-10">
      						<input type="text" name="birthDay" class="form-control myDateFormat" id="birthday" placeholder="dd/MM/yyyy" value=<%=TimeConvert.getStringDatetime(objUsers.getBirthDay()) %>>
    					</div>
 					</div>
 						<div class="form-group">
    					<label for="inputEmail3" class="col-sm-2 control-label">Địa chỉ</label>
   						<div class="col-sm-10">
      						<input type="text" name="address" class="form-control" id="address" placeholder="" value="<%=objUsers.getAddDress()%>">
    					</div>
 					</div>
 						<div class="form-group">
    					<label for="inputEmail3" class="col-sm-2 control-label">Số điện thoại</label>
   						<div class="col-sm-10">
      						<input type="text" name="phoneNumber" class="form-control" id="phone" placeholder="" value="<%=objUsers.getPhoneNumber() %>">
    					</div>
 					</div>
 					<div class="form-group">
