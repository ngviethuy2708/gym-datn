...
public class ControllerAdminAjaxTranfer extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ControllerAdminAjaxTranfer() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String imgActive = "";
		String result = "";
		if(mBill.setActiveTranfer(id,active) > 0){
			if(active == 1){
			...
			result += "<a href='avascript:void(0)' onclick='return setActive1("+id +","+ active +")' title=''><img style='width:30px; height:30px;'' src='" + imgActive + "'></a>";
			out.print(result);
		}
	}
